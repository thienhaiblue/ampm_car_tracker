...
namespace GT400VNReportReader
{
    class Lib
    {
        ...
        public static string latlngToString(double value)
        {
        ...
        public static byte CalcCrc(byte[] buf, int index, int length)
        {
            byte crc;
        ...
        public static uint CalcCrc32(byte[] buf, int index, int length)
        {
            uint crc;
