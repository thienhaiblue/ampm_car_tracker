...
namespace GT400VNTrackerConfiguration
{
    public partial class RegisterForm : Form
    {
        ...
        public const string ENCRYPTION_KEY = "@mb0_GT400VN";
        ...
        public bool CheckProductKey()
        {
            ...
            try
            {
                ...
                { 
                    ...
                    MessageBox.Show("Cannot create product key entry. The program will now abort!");
                    Environment.Exit(0);
                }
            }
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Problem occurred while checking for product license. The program will now abort!");
                Environment.Exit(0);
            }
