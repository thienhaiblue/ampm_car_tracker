...
#define DEFAULT_ROOT_NUMBER	"0978779222"
#define DEFAULT_ID					"thienhaiblue"
...
#define DEFAULT_FSERVER_NAME	"118.69.60.174"
...
#define DEFAULT_SPEED_LIMIT	80 /* km/hr */
...
#define CONFIG_SIZE_RFID_USER_MAX	5
#define CONFIG_SIZE_PHONE_NUMBER_MAX 10

#define CONFIG_SPEED_STOP	5 //km/h

#define FEATURE_RFID	0x0001
#define DEFAULT_FEATURE	FEATURE_RFID
...
// sms user
	...
	uint8_t rfidPass[CONFIG_SIZE_RFID_USER_MAX][CONFIG_SIZE_RFID_PASS];
	int8_t timezone;
...
typedef struct __attribute__((packed))
{
	...
	uint8_t fPassword[CONFIG_SIZE_SERVER_NAME];
// sms user
	uint8_t userPhone[CONFIG_SIZE_PHONE_NUMBER_MAX][CONFIG_SIZE_PHONE_NUMBER];
	uint8_t vehicleID[CONFIG_SIZE_VEHICLE_ID];
	uint8_t rfidPass[CONFIG_SIZE_RFID_USER_MAX][CONFIG_SIZE_RFID_PASS];
	uint32_t deviceTurnOffDelay;
	int8_t timezone;
	uint8_t gSensorSense;
	uint8_t speedLimit;
	uint32_t featureSet;			/*< feature set mapping */
